...
from utils.audio_player import play_alarm_loop_async, speak_alert
...
class AlarmPopup(QWidget):
    ...
    """
    def __init__(self, title="Alarm Alert", label="Time to wake up!", is_reminder=False, custom_sound=None, volume=85):
        super().__init__()
        self.title = title
        self.label = label
    ...
    def trigger_alert(self):
        ...
        self.alarm_handle = play_alarm_loop_async(
